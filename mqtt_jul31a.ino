 ...
 * Modificado: Erick Martínez Flores
 * 
...
//Datos de WiFi
const char* ssid = "Totalplay-F59F";  // Aquí debes poner el nombre de tu red
const char* password = "F59F7166UZ9qycra";  // Aquí debes poner la contraseña de tu red
